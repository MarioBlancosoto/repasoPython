...
class GridModificado(Gtk.Grid):
    def __init__(self):
        ...
        self.add(self.btn1)
        self.attach(self.entrada1,1,0,2,1)
        #pone la etiqueta,tomando como referencia el bt1n,en la posición bottom,después le damos el ancho y luego el alto
        self.attach_next_to(self.etq,self.btn1,Gtk.PositionType.BOTTOM,1,2)
        self.attach_next_to(self.entrada2,self.entrada1,Gtk.PositionType.BOTTOM,2,2)
        self.attach_next_to(self.btn2,self.entrada2,Gtk.PositionType.BOTTOM,1,1)
        self.attach_next_to(self.btn3,self.btn2,Gtk.PositionType.RIGHT,1,1)
